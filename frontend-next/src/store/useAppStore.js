...
export const useAppStore = create((set, get) => ({
  ...
  tickets: [
    ...
    {
      id: 14,
      descricao: "Meu mouse parou de funcionar, já troquei a pilha e nada",
    ...
    },
    {
      id: 17,
      descricao:
        "A impressora da sala de reuniões não imprime, erro de spooler",
    ...
    {
      id: 18,
      descricao: "Internet caiu em toda a empresa, produção parada",
    ...
    {
      id: 19,
      descricao: "Preciso instalar o novo software de videoconferência",
    ...
    },
    {
      id: 20,
      descricao:
        "Minha tela azul aparece toda vez que inicio o computador, BSOD",
  ...
  activities: [
    {
      text: "Chamado #0018 triado · Rede / Crítica",
      color: "var(--color-danger)",
      time: "2min ago",
    },
    {
      text: "Chamado #0016 analisado por IA · 98% de confiança",
      color: "var(--color-primary)",
      time: "5min ago",
    },
    {
      text: "Chamado #0015 avançou → Em Atendimento",
      color: "var(--color-warning)",
      time: "12min ago",
    },
    {
      text: "Chamado #0019 resolvido por Lucas Pereira",
      color: "var(--color-success)",
      time: "28min ago",
    },
    {
      text: "Chamado #0020 resolvido · BSOD corrigido",
      color: "var(--color-success)",
      time: "1h ago",
    },
    {
      text: "Base de teste de IA carregada com sucesso",
  ...
  handleCreate: async (descricao, solicitante) => {
    ...
    try {
      ...
      const r = await axios.post(`${API}/tickets`, {
        descricao,
        solicitante: finalSol,
      });
      get().showToast(
        `✅ Triagem IA #00${r.data.id} · ${r.data.categoria} / ${r.data.prioridade}`,
      );
      get().fetchData();
      return true;
    } catch (e) {
